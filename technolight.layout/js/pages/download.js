                ...
                sections[fileSection].forEach(el => {
                    insertHtml += `
                                        <tr>
                                            <td>${el.name}</td>
                                            <td>${category}</td>
                                            <td>${el.extension} - ${el.size_human}</td>
