...
window.initInformers = (tooltip) => {
    const btns = Array.from(document.querySelectorAll('span:has(.informer-mark)'))
    ...
    const getInformation = async (term) => {
        ...
        formData.append('data', JSON.stringify({term: `${term}`}))
    ...
    btns.forEach(btn => {
        btn.addEventListener('mouseover', () => {
            const icon = btn.querySelector('.informer-mark')
