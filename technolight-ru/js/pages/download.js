                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="download__content">
                                <div class="download__card">
                                    <a href="${catalog.download}" class="download__poster">
                                        <img src="${catalog.preview}" alt="" />
                                    </a>
                                    <div class="download_description">
                                        <a href="${catalog.download}" class="download__name">${catalog.name}</a>
...
const getDataFilesSections = (data) => {
    ...
    for (const tag in normalizedData) {
        normalizedData[tag].sort(compareNames)
    }
